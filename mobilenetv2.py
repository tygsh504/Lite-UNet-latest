...
def MobileNetV2(input_shape=None, alpha=1.0, include_top=True, weights='imagenet', input_tensor=None, pooling=None, classes=1000, **kwargs):
    """
    Wrapper function that calls the built-in TensorFlow MobileNetV2.
    This ensures compatibility with newer TensorFlow versions (2.16+)
    while preserving the original function signature expected by LiteUNet.
    """
    return _MobileNetV2(
